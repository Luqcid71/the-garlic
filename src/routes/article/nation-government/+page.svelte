<script>
  ...
  const article = {
    ...
    body: `WASHINGTON—After years of legislative gridlock, experts confirmed Tuesday that the most powerful governing body in the United States is now a loosely organized group chat titled “Important People Only (Final).” 

According to sources, all major policy decisions are now made between 1:13 a.m. and 2:47 a.m., when members are most active and least likely to read anything carefully. “It’s efficient,” said one participant. “You just drop an idea, someone reacts with a thumbs up, and suddenly it’s law.” 

Critics have raised concerns about transparency, citing the chat’s tendency to spiral into unrelated memes and occasional arguments over who never pays their share for lunch. Still, supporters insist the system reflects “the authentic chaos of democracy.” 

Recently, a major infrastructure bill had been accidentally replaced with a GIF of a raccoon eating cotton candy. `
  };
