<script>
  ...
  const article = {
    section: 'Politics',
    headline: 'ICE Agent Wears Inflatable Dinosaur Costume ',
    byline: 'Craig Keyes',
    role: 'Field Editor, The Garlic',
    date: 'March 23, 2026',
    readTime: '4 min read',
    image: 'https://images.unsplash.com/photo-1516575448682-93a05df8bf59?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    imageCaption: 'ICE',
    imageCredit: 'Photo: Stock',
    body: `PILLAGER, MN – On Tuesday March 24th ICE Agent Nicholas Kirk was caught on video wearing an inflatable dinosaur costume as he went door to door. We asked him why he was in his unusual uniform, and he declined to respond, stating “I don’t talk to female reporters.”  

After we got a man to speak to him he was glad to share his story. “So the mask covers my face, so I thought, why not cover my entire body.” Unfortunately his bizarre costume was taken from the budget for ICE not his own funds, when Kirk submitted for “Work related necessities.” When he bought the 450$ Dino suit. This is the climax to an outrageous increase of ICE atrocities in Minnesota. Locals are asking themselves, how far will ICE go if they are going this far?  

After the agent was caught on camera attempting to unholster his gun but failing due to “Itty Bitty Dino Arms.” He was called back to DC stating “I think my stroke of genius will get me a nice new seat in a higher rank, that’s why they called me back.” We laughed it off, thinking we will hear about his end of employment, then we saw that Nicholas Kirk was put in charge of TSA. `
  };
